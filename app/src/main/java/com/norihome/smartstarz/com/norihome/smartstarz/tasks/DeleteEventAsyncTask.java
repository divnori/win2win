...
public class DeleteEventAsyncTask extends AsyncTask<String, Void, Void> {
    ...
    public Void doInBackground(String... params) {
        System.out.println("------------          delete event task called   --------------------");
        ...
        try {
            //TODO: CHANGE THIS
            myApiService.deleteEvent(params[0]).execute();
        } catch (IOException e) {
            e.printStackTrace();
        }
        System.out.println("------------          returning from delete event task  --------------------");
        return null;
    }
}
