...
public class ClearEventsAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public Void doInBackground(Void... params) {
        System.out.println("------------          clear events task called   --------------------");
        ...
        System.out.println("------------          returning from clear events task  --------------------");
        return null;
    }
}
