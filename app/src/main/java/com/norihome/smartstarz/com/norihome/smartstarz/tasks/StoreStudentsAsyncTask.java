...
public class StoreStudentsAsyncTask extends AsyncTask<StudentBean, Void, Void> {
    ...
    protected Void doInBackground(StudentBean... beans) {
        System.out.println("store students task called");
        ...
        try {
            for (StudentBean bean : beans)
                myApiService.storeStudent(bean).execute();
